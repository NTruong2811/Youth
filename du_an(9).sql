...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 10, 2021 lúc 04:44 PM
...
--
-- Đang đổ dữ liệu cho bảng `chat_content`
--
...
(43, 'Longines Presence', 2500000, 'img/product_28.png', 'Bộ sưu tập Presence đã tái hiện quá trình phát triển của di sản Longines và là một phần tạo nên truyền thống lâu đời. Mẫu đồng hồ Longines L47902112 dành cho nam giới sử dụng màu trắng sang trọng làm mặt số, được điêu khắc rất tinh xảo với chữ số La Mã và cửa sổ ngày trang nhã tại vị trí 3 giờ.', 0, 1, 1000, 0, 4, '2021-11-18 16:21:30', '2021-11-18 16:21:30', 39),
...
(46, 'GraffStar Icon Automatic', 2000000, 'img/product_21.png', 'GraffStar Icon Automatic GSA38PGSLD không chỉ khoác trên mình lớp áo choàng là bộ vỏ vô cùng lông lẫy bằng vàng hồng 18k và kim cương lấp lánh với kích thước 38 mm mà còn sở hữu một cơ chế hoạt động bền bỉ bên trong với bộ máy tự động lên dây cót có khả năng dự trữ lên đến 42 giờ được cài đặt bên trong vỏ. ', 40, 1, 1000, 0, 28, '2021-11-18 16:29:35', '2021-11-18 16:29:35', 40),
...
(3, 'khaidang', 'khaiddph15544@fpt.edu.vn', '25d55ad283aa400af464c76d713c07ad', 'Đặng Đình Khải', '../../admin/user/avatar/PH15544 Đặng Đình Khải.jpg', 19, '0962597441', 0, 1, 'Chí Đám Đoan Hùng', '2021-11-26 19:59:12', '2021-12-03 23:57:47'),
(75, 'truongnn', 'truongnnph15584@fpt.edu.vn', '32e8512c007faaf409e0845a6f6a980d', 'Nguyễn Nhật Trường', '../../admin/user/avatar/myprofile.jpg', 19, '02106573899', 0, 1, 'Hà Nội', '2021-11-26 21:08:45', '2021-12-07 14:40:36'),
...
(89, 'khaidang', 'dangkhai@gmail.com', '25d55ad283aa400af464c76d713c07ad', 'Đặng Khải', '../../admin/user/avatar/PH15544 Đặng Đình Khải.jpg', 19, '0962597441', 0, 0, 'Phú Thọ', '2021-12-07 15:24:33', '2021-12-09 01:11:38');
...
--
ALTER TABLE `cart`
  MODIFY `cart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=272;
...
--
-- Các ràng buộc cho bảng `chat_content`
--
ALTER TABLE `chat_content`
